...
namespace Shop.SQLDataAccess
{
	...
	public interface Lebi_Searchkey_interface
	{
		...
		int Add(Lebi_Searchkey model);
		void Update(Lebi_Searchkey model);
		void Delete(int id);
		void Delete(string strWhere);
		void Delete(SQLPara para);
		Lebi_Searchkey GetModel(int id);
		Lebi_Searchkey GetModel(string strWhere);
		Lebi_Searchkey GetModel(SQLPara para);
		List<Lebi_Searchkey> GetList(string strWhere, string strFieldOrder, int PageSize, int page);
		List<Lebi_Searchkey> GetList(SQLPara para, int PageSize, int page);
		List<Lebi_Searchkey> GetList(string strWhere, string strFieldOrder);
		List<Lebi_Searchkey> GetList(SQLPara para);
		Lebi_Searchkey BindForm(Lebi_Searchkey model);
		Lebi_Searchkey SafeBindForm(Lebi_Searchkey model);
		Lebi_Searchkey ReaderBind(IDataReader dataReader);
	}

	/// <summary>
	/// 数据访问类D_Lebi_Searchkey。
	/// </summary>
	public class D_Lebi_Searchkey
	{
		static Lebi_Searchkey_interface _Instance;
		public static Lebi_Searchkey_interface Instance
		{
		   get
		   {
		        if (_Instance == null)
		        {
		            if (BaseUtils.BaseUtilsInstance.DBType == "access")
		                _Instance = new access_Lebi_Searchkey();
		            else
		                _Instance = new sqlserver_Lebi_Searchkey();
		        }
		        return _Instance;
		    }
		    set
		...
		public D_Lebi_Searchkey()
		{}
		#region  成员方法
	class sqlserver_Lebi_Searchkey : Lebi_Searchkey_interface
	{
		/// <summary>
		...
		public string GetValue(string colName,string strWhere)
		{
			...
			try
			{
				...
				strSql.Append("select " + colName + " from [Lebi_Searchkey]");
				if(strWhere.Trim()!="")
				{
		...
		public int Counts(string strWhere)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [Lebi_Searchkey]");
			if(strWhere.Trim()!="")
				strSql.Append(" where "+strWhere);
		...
		public int GetMaxID(string strWhere)
		{
			...
			StringBuilder strSql = new StringBuilder();
			strSql.Append("select max(id) from [Lebi_Searchkey]");
			if(strWhere.Trim()!="")
				strSql.Append(" where "+strWhere);
			return Convert.ToInt32(SqlUtils.SqlUtilsInstance.TextExecuteScalar(strSql.ToString()));
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [Lebi_Searchkey] ");
			strSql.Append(" where @id=id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
		...
		/// 得到一个对象实体 by SQLpara
		/// </summary>
		public Lebi_Searchkey GetModel(SQLPara para)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select top 1 * from [Lebi_Searchkey] ");
			if (para.Where != "")
		...
		/// 获得数据列表-带分页
		/// </summary>
		public List<Lebi_Searchkey> GetList(string strWhere, string strFieldOrder, int PageSize, int page)
		{
			if (strWhere.IndexOf("lbsql{") > 0)
			{
			...
			string strTableName = "[Lebi_Searchkey]";
		...
		public List<Lebi_Searchkey> GetList(SQLPara para, int PageSize, int page)
		{
			string strTableName = "[Lebi_Searchkey]";
			string strFieldKey = "id";
			StringBuilder strSql=new StringBuilder();
		...
		/// 获得数据列表-不带分页
		/// </summary>
		public List<Lebi_Searchkey> GetList(string strWhere,string strFieldOrder)
		{
			if (strWhere.IndexOf("lbsql{") > 0)
			{
				SQLPara para = new SQLPara(strWhere, strFieldOrder, "");
			...
			strSql.Append(" FROM [Lebi_Searchkey] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public List<Lebi_Searchkey> GetList(SQLPara para)
		{
			string strTableName = "[Lebi_Searchkey]";
			StringBuilder strSql=new StringBuilder();
	...
	class access_Lebi_Searchkey : Lebi_Searchkey_interface
	{
		/// <summary>
		/// 根据字段名，where条件获取一个值,返回字符串
		/// </summary>
		...
		public int Counts(string strWhere)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [Lebi_Searchkey]");
			if(strWhere.Trim()!="")
				strSql.Append(" where "+strWhere);
