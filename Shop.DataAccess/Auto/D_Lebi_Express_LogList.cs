...
namespace Shop.SQLDataAccess
{
	...
	public interface Lebi_Express_LogList_interface
	{
		...
		int Add(Lebi_Express_LogList model);
		void Update(Lebi_Express_LogList model);
		void Delete(int id);
		void Delete(string strWhere);
		void Delete(SQLPara para);
		Lebi_Express_LogList GetModel(int id);
		Lebi_Express_LogList GetModel(string strWhere);
		Lebi_Express_LogList GetModel(SQLPara para);
		List<Lebi_Express_LogList> GetList(string strWhere, string strFieldOrder, int PageSize, int page);
		List<Lebi_Express_LogList> GetList(SQLPara para, int PageSize, int page);
		List<Lebi_Express_LogList> GetList(string strWhere, string strFieldOrder);
		List<Lebi_Express_LogList> GetList(SQLPara para);
		Lebi_Express_LogList BindForm(Lebi_Express_LogList model);
		Lebi_Express_LogList SafeBindForm(Lebi_Express_LogList model);
		Lebi_Express_LogList ReaderBind(IDataReader dataReader);
	}

	/// <summary>
	/// 数据访问类D_Lebi_Express_LogList。
	/// </summary>
	public class D_Lebi_Express_LogList
	{
		static Lebi_Express_LogList_interface _Instance;
		public static Lebi_Express_LogList_interface Instance
		{
		   get
		   {
		        if (_Instance == null)
		        {
		            if (BaseUtils.BaseUtilsInstance.DBType == "access")
		                _Instance = new access_Lebi_Express_LogList();
		            else
		                _Instance = new sqlserver_Lebi_Express_LogList();
		        }
		        return _Instance;
		    }
		    set
		...
		public D_Lebi_Express_LogList()
		{}
		#region  成员方法
	class sqlserver_Lebi_Express_LogList : Lebi_Express_LogList_interface
	{
		/// <summary>
		...
		public string GetValue(string colName,string strWhere)
		{
			...
			try
			{
				...
				strSql.Append("select " + colName + " from [Lebi_Express_LogList]");
				if(strWhere.Trim()!="")
				{
		...
		public int Counts(string strWhere)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [Lebi_Express_LogList]");
			if(strWhere.Trim()!="")
				strSql.Append(" where "+strWhere);
		...
		public int GetMaxID(string strWhere)
		{
			...
			StringBuilder strSql = new StringBuilder();
			strSql.Append("select max(id) from [Lebi_Express_LogList]");
			if(strWhere.Trim()!="")
				strSql.Append(" where "+strWhere);
			return Convert.ToInt32(SqlUtils.SqlUtilsInstance.TextExecuteScalar(strSql.ToString()));
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [Lebi_Express_LogList] ");
			strSql.Append(" where @id=id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
		...
		/// 得到一个对象实体 by SQLpara
		/// </summary>
		public Lebi_Express_LogList GetModel(SQLPara para)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select top 1 * from [Lebi_Express_LogList] ");
			if (para.Where != "")
		...
		/// 获得数据列表-带分页
		/// </summary>
		public List<Lebi_Express_LogList> GetList(string strWhere, string strFieldOrder, int PageSize, int page)
		{
			if (strWhere.IndexOf("lbsql{") > 0)
			{
			...
			string strTableName = "[Lebi_Express_LogList]";
		...
		public List<Lebi_Express_LogList> GetList(SQLPara para, int PageSize, int page)
		{
			string strTableName = "[Lebi_Express_LogList]";
			string strFieldKey = "id";
			StringBuilder strSql=new StringBuilder();
		...
		/// 获得数据列表-不带分页
		/// </summary>
		public List<Lebi_Express_LogList> GetList(string strWhere,string strFieldOrder)
		{
			if (strWhere.IndexOf("lbsql{") > 0)
			{
				SQLPara para = new SQLPara(strWhere, strFieldOrder, "");
			...
			strSql.Append(" FROM [Lebi_Express_LogList] ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public List<Lebi_Express_LogList> GetList(SQLPara para)
		{
			string strTableName = "[Lebi_Express_LogList]";
			StringBuilder strSql=new StringBuilder();
	...
	class access_Lebi_Express_LogList : Lebi_Express_LogList_interface
	{
		/// <summary>
		/// 根据字段名，where条件获取一个值,返回字符串
		/// </summary>
		...
		public int Counts(string strWhere)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(*) from [Lebi_Express_LogList]");
			if(strWhere.Trim()!="")
				strSql.Append(" where "+strWhere);
