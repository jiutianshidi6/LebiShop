...
namespace Shop.Admin.product
{
    public partial class product_freeze_window : AdminAjaxBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string where = "select a.id from Lebi_Order_Product as a inner join  Lebi_Order as b on a.Order_id = b.id where " + sql + " and a.Count > a.Count_Shipped and b.IsInvalid = 0 and b.IsCompleted = 0 and b.Type_id_OrderType = 211";
