...
namespace Shop.Ajax
{
    ...
    public partial class Ajax_agent : ShopPage
    {
        ...
        public void TackAgentMoney()
        {
            ...
            string sql = "update Lebi_Agent_Money set Type_id_AgentMoneyStatus=384 where User_id=" + CurrentUser.id + " and Type_id_AgentMoneyStatus=382 and datediff(d,Time_add,'" + System.DateTime.Now + "')>" + SYS.CommissionMoneyDays + "";
