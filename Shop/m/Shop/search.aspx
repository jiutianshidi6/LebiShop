...
<% LoadPage("ljq@lebi.cn_43",15,"CN","P_ShopSearch"); %>
...
<div class="mhead clearfix">
	...
	<h2 id="pagename"><%=ThemePageMeta("P_ShopSearch","title")%></h2>
    ...
    <div class="mc clearfix">
                ...
                <%foreach (Shop.Model.Lebi_Supplier model in shops)
        {
                ...
                <li class="grid loadli">
                    <div class="proimg">
                        <p>
                            <a href="<%=URL("P_ShopIndex",model.id) %>"><img <%if (CurrentLanguage.IsLazyLoad==1){ %>class="lazy" src="/Theme/system/wap/images/lazy.gif" data-original<%}else{ %>src<%} %>="<%=Image(model.Logo)%>" alt="<%=Lang(model.Name) %>" title="<%=Lang(model.Name) %>" /></a></p>
                    </div>
                    <div class="proname">
