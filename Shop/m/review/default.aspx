...
<% LoadPage("ljq@lebi.cn_43",15,"CN","P_ProductCommentIndex"); %>
...
<script src="/Theme/system/wap/js/jquery.masonry.min.js" type="text/javascript"></script>
...
<div class="mhead clearfix">
	...
	<h2 id="pagename"><%=ThemePageMeta("P_ProductCommentIndex","title")%></h2>
