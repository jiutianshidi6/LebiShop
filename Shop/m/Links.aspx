...
<% LoadPage("ljq@lebi.cn_43",15,"CN","P_FriendLink"); %>
...
<div class="mhead clearfix">
	...
	<h2 id="pagename"><%=ThemePageMeta("P_FriendLink","title")%></h2>
...
<div class="friendlinklist">
    ...
    <div class="mc clearfix">
        <ul class="image">
            <%Table="Lebi_FriendLink";Where="IsShow=1 and IsPic=1 and ','+Language_ids+',' like '%," + CurrentLanguage.id + ",%'";Order="Sort desc,id desc";PageSize=20;pageindex=Rint("page");RecordCount=B_Lebi_FriendLink.Counts(Where);int kiwV_index=1;
List<Lebi_FriendLink> kiwVs = B_Lebi_FriendLink.GetList(Where, Order,PageSize ,pageindex);foreach (Lebi_FriendLink kiwV in kiwVs){%>
            <li>
                <p><a href="<%=kiwV.Url%>" target="_blank"><img src="<%=kiwV.Logo%>" alt="<%=kiwV.Name%>" /></a></p>     
            </li>
            <%kiwV_index++;}%>
        </ul>
        <div class="clear"></div>
    ...
    <div class="mc clearfix">
        <ul class="text">
            <%Table="Lebi_FriendLink";Where="IsShow=1 and IsPic=0 and ','+Language_ids+',' like '%," + CurrentLanguage.id + ",%'";Order="Sort desc,id desc";PageSize=20;pageindex=Rint("page");RecordCount=B_Lebi_FriendLink.Counts(Where);int mANa_index=1;
List<Lebi_FriendLink> mANas = B_Lebi_FriendLink.GetList(Where, Order,PageSize ,pageindex);foreach (Lebi_FriendLink mANa in mANas){%>
            <li>
                <a href="<%=mANa.Url%>" target="_blank"><%=mANa.Name%></a>     
            </li>
            <%mANa_index++;}%>
        </ul>
        <div class="clear"></div>
