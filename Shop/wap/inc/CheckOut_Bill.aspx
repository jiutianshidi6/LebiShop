<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.inc.CheckOut_Bill" validateRequest="false"%>
...
<div class="dl-table clearfix">
    ...
    <dl>
        ...
        <dd><em><%=Lang(model.Description)%></em>&nbsp;&nbsp;<%=Tag("税金")%>：<%=FormatMoney(model.TaxRate * (basket.Money_Product + basket.Money_Property - basket.Money_Cut - basket.Money_Give))%></dd>
    </dl>
