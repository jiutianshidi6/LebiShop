<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.inc.viewhistory" validateRequest="false"%>
<ul class="image">
    <% 
    ...
    <li>
        <div class="image">
            <p><a href="<%=URL("P_Product",p.Product_id) %>"><img src="<%=Image(productmodel.ImageMedium) %>" alt="<%=Lang(productmodel.Name) %>" title="<%=Lang(productmodel.Name) %>" /></a></p>
        </div>
        <div class="name">
