<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.supplier.product.product_Image_Edit_window" validateRequest="false"%>
...
<table cellspacing="0" border="0" style="width: 100%;" class="table">
    <tr>
        ...
        <td>
            <div id="image_ImageSmallson">
                <%if (model.ImageSmall != "")
                  {%>
                <img height="30" src="<%=model.ImageSmall%>" />
                <%} %>
            </div>
            <input type="hidden" shop="true" id="ImageSmallson" name="ImageSmallson" class="input" style="width: 200px;" value="<%=model.ImageSmall%>" />
            <input id="file_ImageSmallson" name="file_ImageSmallson" class="input" onchange="uploadImage('ImageSmallson')" type="file" />
...
<script type="text/javascript">
    function SavePImageObj() {
        var smalliamge = $("#ImageSmallson").val();
