<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.supplier.product.imagesupload" validateRequest="false"%>

<script type="text/javascript" src="<%=site.AdminJsPath %>/jquery.dragsort-0.5.1.min.js"></script>
...
<style>
    ...
    #<%=inputname %>images{POSITION: relative; width:500px; list-style-type:none; margin:0; padding:0; z-index:5}
</style>
<ul id="<%=inputname %>images">
    <%
        ...
        <li class="imagespreviewlist" id="<%=inputname %>img<%=i %>">
            <span class="image">
                <img src="<%=site.WebPath + model.small %>" /><input type="hidden" name="pic" value="<%=model.small %>" />
            </span>
...
<div><iframe src="upload.aspx?n=<%=inputname %>&i=<%=i %>" frameborder="0" width="400" height="33px" scrolling="no" allowtransparency="true"></iframe>
</div>
