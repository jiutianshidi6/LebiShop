<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.supplier.order.Print_Shipping" validateRequest="false"%>
...
<h2><%=Lang(CurrentSupplier.Name)%> <%=Tag("发货单")%></h2>
