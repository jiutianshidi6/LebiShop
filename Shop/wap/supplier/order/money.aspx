<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Supplier.Order.UserMoney" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <div class="searchbox">
        ...
        <div style="margin-top:5px;">
             <%=Tag("有效金额") %>：<%=CurrentCurrency.Msige %><%=zmoney.ToString("0.00") %>
             <%=Tag("可提现金额") %>：<%=CurrentCurrency.Msige %><%=money.ToString("0.00")%>
