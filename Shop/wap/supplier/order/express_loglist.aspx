<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Supplier.Order.Express_LogList" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <li class="name"><span id="navIgation"><%=Tag("当前位置")%>：<a href="<%=site.AdminPath %>/Ajax/ajax_supplier.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a> > <a href="<%=site.AdminPath %>/Ajax/ajax_supplier.aspx?__Action=MenuJump&pid=0"><%=Tag("打印清单")%></a> > <%=Tag("清单列表")%></span></li>
    </ul>
    </div>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0" class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_Express_LogList model in models)
          {%>
