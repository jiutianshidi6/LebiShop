<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Supplier.Config.Transport" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <div class="tools">
    <ul>
    <li class="name"><span id="navIgation"><%=Tag("当前位置")%>：<a href="<%=site.AdminPath %>/Ajax/ajax_supplier.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a> > <%=Tag("配送方式")%></span></li>
    </ul>
    </div>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0" class="datalist">
        ...
        <tr class="list">
            ...
            <td>
                <a href="Transport_Price.aspx?tid=<%=model.id %>"><%=Tag("配送区域")%></a>
            </td>
        </tr>
        <%} %>
