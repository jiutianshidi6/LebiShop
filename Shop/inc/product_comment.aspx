...
<div class="comments_top">
    ...
    <div class="comments_section_3">
        ...
        <ul>
            ...
            <%
            Shop.Model.Lebi_Order_Product order_product = Shop.Bussiness.B_Lebi_Order_Product.GetModel("IsCommented = 0 and User_id=" + CurrentUser.id + " and Product_id = "+ id +" and id in(select id from [Lebi_Order_Product] where Order_id in(select id from [Lebi_Order] where User_id=" + CurrentUser.id + " and IsReceived = 1))");
