...
<div class="dl-table clearfix">
    <%foreach (Shop.Model.BasketShop shop in Shops)
      {
          ...
          Shop.Model.Lebi_Transport tran=GetTransport(shop.Shop.id);
    %>
    <dl>
        <dt><%=tran.Name%></dt>
    ...
    Shop.Model.Lebi_PickUp pickup=GetPickup(CurrentUser.PickUp_id,shop);
    if(pickup!=null){
    %>
...
<div class="dl-table clearfix">
    ...
    <dl class="pickup" id="pickup<%=shop.Shop.id %>" style="display:none;">
        <dd class="list">
            ...
            <% 
                foreach (Shop.Model.Lebi_PickUp pickup in GetPickups(shop))
                {
                %>
                <dl>
