<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.order.Express_Shipper" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <%}%>
    <li class="name"><span id="navIgation"><%=Tag("当前位置")%>：<a href="<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a> > <a href="<%=site.AdminPath %>/order/Express.aspx"><%=Tag("快递单模板")%></a> > <%=Tag("发货人管理")%></span></li>
    </ul>
    </div>
    ...
    <div class="searchbox clear">
        ...
        <ul class="tabmenus">
            <li><a href="Express.aspx"><span><%=Tag("快递单模板")%></span></a></li>
            <li class="current"><a href="Express_Shipper.aspx"><span><%=Tag("发货人管理")%></span></a></li>
        </ul>
        </div>
    ...
    <table class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_Express_Shipper model in models)
          {%>
    ...
    <script type="text/javascript">
        ...
        function Edit(id) {
            ...
            var url_ = "express_shipper_edit_window.aspx?id=" + id;
            var width_ = 600;
            var height_ = "auto";
            var modal_ = true;
