...
<body>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function selectproduct(id){
            ...
            var url_ = "selectproduct_window.aspx?orderid=<%=model.id %>&id=" + id+"&pnumber="+pnumber;
            var width_ = 500;
            var height_ = "auto";
            var modal_ = true;
        ...
        {
            var title_ = "<%=Tag("编辑")%>";
            var url_ = "order_baseinfo_edit_window.aspx?id=" + id;
            var width_ = 500;
            var height_ = "auto";
            var modal_ = true;
            EditWindow(title_, url_, width_, height_, modal_, 'selectproduct');
        ...
        {
            var title_ = "<%=Tag("发票")%>";
            var url_ = "<%=site.AdminPath %>/order/bill_edit_window.aspx?orderid=" + id;
            var width_ = 500;
            var height_ = "auto";
            var modal_ = true;
            EditWindow(title_, url_, width_, height_, modal_, 'selectproduct');
...
<div class="print-btn">
    <div class="tools">
        <ul>
            <%if (model.IsRefund == 1){ %>
                <li class="tip"><a href="#"><b></b><span><%=Tag("已取消")%></span></a></li>
            <%} %>
            ...
            <%}else{%>
                <%if (model.IsRefund == 2){ %>
                    <li class="submit"><a href="#" class="a-btn" onclick="Order_type(1,<%=model.id %>,'IsRefund');"><b></b><span><%=Tag("同意")%><%=Tag("取消订单")%></span></a></li>
                    <li class="cancel"><a href="#" class="a-btn" onclick="Order_type(3,<%=model.id %>,'IsRefund');"><b></b><span><%=Tag("拒绝")%><%=Tag("取消订单")%></span></a></li>
                ...
                <%}else{ %>
                    <li class="cancel"><a href="#" class="a-btn" onclick="Order_type(0,<%=model.id %>,'IsVerified');"><b></b><span><%=Tag("取消审核")%></span></a></li>
                    <%if (model.Type_id_OrderType != 212){%>
                        <%if (model.IsPaid != 1){ %>
                            <li class="submit"><a href="#" class="a-btn" onclick="Order_type(1,<%=model.id %>,'IsPaid')"><b></b><span><%=Tag("已支付")%></span></a></li>
                        <%}else{%>
                            <li class="cancel"><a href="#" class="a-btn" onclick="Order_type(0,<%=model.id %>,'IsPaid')"><b></b><span><%=Tag("未支付")%></span></a></li>
                        <%} %>
    ...
    <div class="main" id="infotab">
        <div class="mod-tab">
            <div class="tablist">
                <ul>
                    ...
                    <li><a><span><%=Tag("配送记录")%><strong>(<%if (TransportCount>0){ %><font><%=TransportCount %></font><%}else{%>0<%} %>)</strong></span></a></li>
                    <li><a><span><%=Tag("订单备注")%></span></a></li>
                    <li><a><span><%=Tag("订单留言")%><strong>(<%if (CommentCount>0){ %><font><%=CommentCount %></font><%}else{%>0<%} %>)</strong></span></a></li>
                    <li><a><span><%=Tag("订单日志")%><strong>(<%if (LogCount>0){ %><font><%=LogCount %></font><%}else{%>0<%} %>)</strong></span></a></li>
                </ul>
            </div>
        </div>
        ...
        <div style="display: block" class="cont">
            ...
            <div id="process" class="section2">
                ...
                <%if (model.IsRefund == 1){ %>
                    <div class="node ready"><ul><li class="tx1">&nbsp;</li><li class="tx2"><%=Tag("已取消")%></li><li class="tx3"><%=FormatTime(model.Time_Refund)%></li></ul></div>
                <%}else{ %>
            ...
            <div id="process" class="section3">
		        <div class="node fore ready"><ul><li class="tx1">&nbsp;</li><li class="tx2"><%=Tag("提交订单")%></li><li class="tx3"><%=FormatTime(model.Time_Add) %></li></ul></div>
                <div class="proce ready"><ul><li class="tx1">&nbsp;</li></ul></div>
                <div class="node ready"><ul><li class="tx1">&nbsp;</li><li class="tx2"><%=Tag("申请取消")%></li><li class="tx3"><%=FormatTime(model.Time_Refund)%></li></ul></div>
            	<div class="proce wait"><ul><li class="tx1">&nbsp;</li></ul></div>
                <div class="node wait"><ul><li class="tx1">&nbsp;</li><li class="tx2"><%=Tag("审核订单")%></li><li class="tx3"></li></ul></div>
            </div>
            <%}else{ %>
            ...
            <div id="process" class="section3">
                ...
                <%}
                  ...
                  { %>
            	<div class="proce ready"><ul><li class="tx1">&nbsp;</li></ul></div>
                <div class="node ready"><ul><li class="tx1">&nbsp;</li><li class="tx2"><%=Tag("已完成")%></li><li class="tx3"><%=FormatTime(model.Time_Completed)%></li></ul></div>
                <%} %>
            </div>
            <%}else{ %>
            <div id="process" class="section5">
                ...
                <%}
                  ...
                  { %>
            	<div class="proce ready"><ul><li class="tx1">&nbsp;</li></ul></div>
                <div class="node ready"><ul><li class="tx1">&nbsp;</li><li class="tx2"><%=Tag("已支付")%></li><li class="tx3"><%=FormatTime(model.Time_Paid) %></li></ul></div>
                <%} %>
                ...
                <div class="node ready"><ul><li class="tx1">&nbsp;</li><li class="tx2"><%if (model.IsShipped_All != 1)
                                                                                         ...
                                                                                         { %><%=Tag("已发货")%><%} %></li><li class="tx3"><%=FormatTime(model.Time_Shipped)%></li></ul></div>
                <%} %>
                ...
                <%}
                  ...
                  { %>
            	<div class="proce ready"><ul><li class="tx1">&nbsp;</li></ul></div>
                <div class="node ready"><ul><li class="tx1">&nbsp;</li><li class="tx2"><%=Tag("已收货")%></li><li class="tx3"><%=FormatTime(model.Time_Received)%></li></ul></div>
                <%} %>
                <%if (model.IsCompleted != 1)
                  { %>
            	<div class="proce wait"><ul><li class="tx1">&nbsp;</li></ul></div>
                                    ...
                                    <div class="mod-table-main">
                                        <div class="con style02">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td width="100" align="right"><%=Tag("转移金额")%>：</td>
                                                    <td>
                                                    <%=FormatMoney(model.Money_fromorder)%>
                                                    <%=FormatMoney(model.Money_fromorder, model.Currency_Code)%></td>
                                                </tr>
                                                <%} %>
                                                ...
                                                <tr>
                                                    <td align="right" valign="top"><%=Tag("退税信息")%>
                                                    </td>
                                                    <td>
                                        ...
                                        <div class="con style02">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span id="Span3"><a href="../user/default.aspx?key=<%=model.User_UserName%>"><%=model.User_UserName%></a></span>
                                                    </td>
                                                </tr>   
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td>
                                                        <span id="Span4"><%=Shop.Bussiness.EX_User.GetUser(model.User_id).RealName %></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td>
                                                        <span id="Span5"><%=Shop.Bussiness.EX_User.GetUser(model.User_id).Phone %></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td>
                                                        <span id="Span6"><%=Shop.Bussiness.EX_User.GetUser(model.User_id).MobilePhone %></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td>
                                                        <span id="Span7"><%=Shop.Bussiness.EX_Area.GetAreaName(Shop.Bussiness.EX_User.GetUser(model.User_id).Area_id)%></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td>
                                                        <span id="Span8"><%=Shop.Bussiness.EX_User.GetUser(model.User_id).Address %></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td>
                                                        <span id="Span9"><%=Shop.Bussiness.EX_User.GetUser(model.User_id).Postalcode %></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td>
                                                        <span id="Span10"><%=Shop.Bussiness.EX_User.GetUser(model.User_id).Email %></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
        ...
        <div style="display: none" class="cont">
            ...
            <div class="mod-table-main">
                ...
                <div style="text-align:left;margin-top:10px;">
                    ...
                    <th>
                        <%=Tag("提单号")%>：
                        <input type="text" shop="true" id="BLNo" name="BLNo" class="input" value="<%=model.BLNo %>" />&nbsp;&nbsp;
                        <%=Tag("集装箱号")%>：
                        <input type="text" shop="true" id="ContainerNo" name="ContainerNo" class="input" value="<%=model.ContainerNo %>" />&nbsp;&nbsp;
                        <%=Tag("船号")%>：
                        <input type="text" shop="true" id="SealNo" name="SealNo" class="input" value="<%=model.SealNo %>" />
                    </th>
                    </tr>
                    </table>
                </div>
                <div style="text-align:left;margin-top:10px;" class="clearfix">
        ...
        <div class="cont">
            ...
            <div class="mod-table-main">
                ...
                <tr>
                <th height="30">
                <label><input type="radio" name="mark" shop="true" value="0" <%if (model.Mark == 0){Response.Write("checked");} %> /> <img src="<%=AdminImage("mark/0.png")%>" height="12" /></label>&nbsp;
                <label><input type="radio" name="mark" shop="true" value="1" <%if (model.Mark == 1){Response.Write("checked");} %> /> <img src="<%=AdminImage("mark/1.png")%>" height="12" /></label>&nbsp;
	            <label><input type="radio" name="mark" shop="true" value="2" <%if (model.Mark == 2){Response.Write("checked");} %> /> <img src="<%=AdminImage("mark/2.png")%>" height="12" /></label>&nbsp;
	            <label><input type="radio" name="mark" shop="true" value="3" <%if (model.Mark == 3){Response.Write("checked");} %> /> <img src="<%=AdminImage("mark/3.png")%>" height="12" /></label>&nbsp;
	            <label><input type="radio" name="mark" shop="true" value="4" <%if (model.Mark == 4){Response.Write("checked");} %> /> <img src="<%=AdminImage("mark/4.png")%>" height="12" /></label>&nbsp;
	            <label><input type="radio" name="mark" shop="true" value="5" <%if (model.Mark == 5){Response.Write("checked");} %> /> <img src="<%=AdminImage("mark/5.png")%>" height="12" /></label>
                </th>
                </tr>
                <tr>
                <th colspan="2">
            ...
            <div class="mod-table-main">
                ...
                <tr>
                <th height="30">
                <select name="Supplier_Delivery_id" shop="true">
                <option value="0"><%=Tag("请选择")%></option>
                <%foreach (Shop.Model.Lebi_Supplier_Delivery delivery in deliveries){ %>
        ...
        <div class="cont">
            ...
            <div class="mod-table-main" style="margin-top:10px">
                <div class="con style05">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
