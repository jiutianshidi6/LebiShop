<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.product.Unit_Edit_window" validateRequest="false"%>
...
<script type="text/javascript">
    ...
    function SaveObj() {
        ...
        if (!CheckForm("shop", "span"))
            return false;
        var url = "<%=site.AdminPath %>/ajax/ajax_product.aspx?__Action=Unit_Edit&id=<%=model.id %>";
