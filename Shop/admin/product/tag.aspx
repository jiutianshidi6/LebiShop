<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.product.Tag" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <table class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_Pro_Tag model in models)
          { %>
        <tr class="list" ondblclick="Edit(<%=model.id %>);" >
            ...
            <td>
                <%=Lang(model.Name)%>&nbsp;<a href="<%=Shop.Bussiness.ThemeUrl.GetURL("P_ProductCategory", "$,$,$,$,$,"+model.id+"", "", CurrentLanguage.Code)%>" target="_blank"><img src="<%=PageImage("icon/newWindow.png")%>" /></a>
            </td>
            <td>
                <%=model.Sort%>
            </td>
