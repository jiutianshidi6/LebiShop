<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.product.class_site_edit_window" validateRequest="false"%>
...
<script type="text/javascript">
    function SaveObj(){
        ...
        var url="<%=site.AdminPath %>/ajax/ajax_product.aspx?__Action=Class_Site_Edit";
