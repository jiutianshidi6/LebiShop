...
<div class="mainbody_top">
    ...
    <script type="text/javascript">
        ...
        function CreateProduct(){
            ...
            var postData={ "ggs": ggs,"pid":pid,"tid":tid,"randnum":<%=randnum %> };
        ...
        function Product_Edit_muti() {
            ...
            var action = $("#action").val();
            var url = "<%=site.AdminPath %>/ajax/ajax_product.aspx?__Action=Product_Edit_muti_price_store&pid=<%=id %>&randnum=<%=randnum %>";
        ...
        function Product_Name_Edit(id) {
            ...
            var url_ = "product_name_edit_window.aspx?randnum=<%=randnum %>&pid=<%=id %>&id=" + id;
            var width_ = 560;
            var height_ = 'auto';
            var modal_ = true;
        ...
        function Product_Remark_Edit(id) {
            var title_ = "<%=Tag("内部备注")%>";
            var url_ = "product_remark_edit_window.aspx?randnum=<%=randnum %>&pid=<%=id %>&id=" + id;
            var width_ = 560;
            var height_ = 'auto';
            var modal_ = true;
            EditWindow(title_, url_, width_, height_, modal_);
        ...
        function Product_Image_Edit() {
            ...
            var url_ = "product_image_edit_window.aspx?randnum=<%=randnum %>&id=<%=id %>&ids=" + ids;
            var width_ = 600;
            var height_ = 'auto';
            var modal_ = true;
            EditWindow(title_, url_, width_, height_, modal_);
