...
<div id="sidecontent" class="clear">
    ...
    <div class="tools">
        <ul>
            <%if (PageReturnMsg == ""){%>
            <%if (t == "copy"){ %>
            <li class="tip"><a href="javascript:void(0);"><b></b><span><%=Tag("复制")%></span></a></li><%} %>
            ...
            <li class="name">
                <span id="navIgation">
                    <%=Tag("当前位置")%>：<a href="<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a> > <a href="<%=site.AdminPath %>/product/default.aspx"><%=Tag("商品管理")%></a> > <%=Shop.Tools.Utils.CutString(Shop.Bussiness.Language.Content(model.Name, CurrentLanguage.Code),30,true) %><%if (t == "copy"){ %>（<%=Tag("复制")%>）<%} %>
                </span>
            </li>
        </ul>
    </div>
    ...
    <div class="mainbody_top">
        <ul class="tablist">
            ...
            <%if (model.id>0){ %>
            <li onclick="Edit(4);" id="p4"><a><span><%=Tag("商品规格")%></span></a></li><%} %>
        </ul>
    </div>
            ...
            <tbody id="lang_<%=lang.Code %>" class="lang_table" style="display: none">
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="Introduction<%=lang.Code %>" shop="true" name="Introduction<%=lang.Code %>"
                                  class="textarea" style="height: 55px; width: 500px;">
                            <%=ContentImage(Shop.Bussiness.Language.Content(model.Introduction, lang.Code))%>
                        </textarea>
                        ...
                        <div class="tools clear">
                            <ul>
                                <li class="plus">
                                    <a href="javascript:void(0);" onclick="javascript:resizeEditor('Introduction<%=lang.Code %>',100);">
                                        <b></b><span>
                                            <%=Tag("展开")%>
                                        </span>
                                    </a>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="Description<%=lang.Code %>" shop="true" id="Description<%=lang.Code %>"
                                  class="text">
                            <%=ContentImage(Shop.Bussiness.Language.Content(model.Description, lang.Code))%>
                        </textarea><%if (CountSon(model.id) > 0 && i == 0)
                        { %><label title="<%=Tag(" 同步更新子商品")%>
                            "><input type="checkbox" name="UpdateDescription" shop="true"
                                     id="UpdateDescription" value="1" /><em><%=Tag("同步")%></em>
                        </label><%} %>
                ...
                <tr>
                    ...
                    <td>
                        <textarea style="height: 60px; width: 500px;" shop="true" name="MobileDescription<%=lang.Code %>"
                                  id="MobileDescription<%=lang.Code %>" class="input">
                            <%=ContentImage(Shop.Bussiness.Language.Content(model.MobileDescription, lang.Code))%>
                        </textarea><%if (CountSon(model.id) > 0 && i == 0)
                        { %><label title="<%=Tag(" 同步更新子商品")%>
                            "><input type="checkbox" name="UpdateMobileDescription"
                                     shop="true" id="UpdateMobileDescription" value="1" /><em><%=Tag("同步")%></em>
                        </label><%} %>
                        <script type="text/javascript">
                ...
                <tr>
                    <th class="head" colspan="2" onclick="ShowChild('0<%=lang.Code%>,1<%=lang.Code%>,2<%=lang.Code%>','seo')">
                        ...
                        { %><label title="<%=Tag(" 同步更新子商品")%>
                            "><input type="checkbox"
                                     name="UpdateSEO" shop="true" id="UpdateSEO" value="1" /><em><%=Tag("同步")%></em>
                        </label><%} %>
                    </th>
                </tr>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateUnits_id" shop="true" id="UpdateUnits_id" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <%if (model.id == 0 || (model.id > 0 && model.Product_id == 0))
            ...
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateTags" shop="true" id="UpdateTags" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div style="float: left;" id="divBrnad">
                        ...
                        { %><label title="<%=Tag(" 同步更新子商品")%>
                            "><input type="checkbox"
                                     name="UpdateBrand_id" shop="true" id="UpdateBrand_id" value="1" /><em><%=Tag("同步")%></em>
                        </label><%} %>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateCount_StockCaution" shop="true" id="UpdateCount_StockCaution" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <%} %>
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdatePackageRate" shop="true" id="UpdatePackageRate" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateWeight" shop="true" id="UpdateWeight" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateNetWeight" shop="true" id="UpdateNetWeight" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateVolume" shop="true" id="UpdateVolume" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <%if (model.id == 0 || (model.id > 0 && model.Product_id == 0))
            ...
            <tr>
                ...
                <td>
                    ...
                    <label>
                        ...
                        <%=(","+model.Pro_Tag_id+",").Contains(","+pt.id+",")?"checked":"" %> /><%=Shop.Bussiness.Language.Content(pt.Name,CurrentLanguage.Code) %>
                    </label>
                    <%} %>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateType_id_ProductType" shop="true" id="UpdateType_id_ProductType" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            ...
            <tbody id="yudingbody">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" shop="true" name="Price_reserve" value="<%=model.Price_reserve %>"
    ...
    <div id="table3" style="display: none">
        <table class="table">
            <tr>
                ...
                <td>
                    ...
                    <table cellpadding="0" cellspacing="0" style="width:700px;display:none;" class="steppricetable" align="left" id="combotable">
                        ...
                        <%
                        int comboi=0;
                        foreach(Shop.Model.Lebi_Product_Combo combo in comboProducts){
                        Shop.Model.Lebi_Product cp=Shop.Bussiness.EX_Product.GetProduct(combo.Product_id_son);
                        %>
                        <tr id="combo<%=comboi%>">
                            <td>
                            ...
                            <td>
                                <a href="javascript:void(0);" onclick="selectcomboproduct(<%=comboi%>);"><%=Tag("选择")%></a> |
            ...
            <tr>
                ...
                <td>
                    <label title="<%=Tag(" 同步更新子商品")%>
                        ">
                        <input type="checkbox" name="UpdateProPerty133" shop="true" id="UpdateProPerty133" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
        </table>
        ...
        {
            comboi++;
            var row='<tr id="combo'+comboi+'"><td><input type="text" class="input"  shop="true"  name="combo_Number" style="width: 90px;" value="" /></td>';
            row+='<td><input type="text" class="input"  shop="true"  name="combo_Count" style="width: 70px;" value="" onkeyup="value=value.replace(/[^.\\d]/g,\'\')" /></td>';
            row+='<td align="left"></td>';
            row+='<td><a href="javascript:void(0);" onclick="selectcomboproduct('+comboi+');"><%=Tag("选择")%></a> | <a href="javascript:void(0);" onclick="$(this).parent().parent().remove();"><%=Tag("删除")%></a></td></tr>';
            $("#combotable").append(row);
        }
        var currentcomboi=0;
        function selectcomboproduct(id)
        {
            currentcomboi=id;
            var title_ = "双击选择商品";
        ...
        function search_product(Product_id,number) {
            //alert(number);
            $('#combo'+currentcomboi).find($('input[name="combo_Number"]')).val(number);
            $('#combo'+currentcomboi).find($('input[name="combo_Count"]')).val(1);
        ...
        <table class="table">
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdatePrice_Market" shop="true" id="UpdatePrice_Market" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdatePrice_Cost" shop="true" id="UpdatePrice_Cost" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <%} %>
            <tr>
                ...
                <td>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdatePrice" shop="true" id="UpdatePrice" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateStepPrice" shop="true" id="UpdateStepPrice" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <tr>
                ...
                <td align="left">
                    <table cellpadding="0" cellspacing="0" style="width:350px" class="steppricetable" align="left" id="Table6">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="input" shop="true" name="userlevelprice<%=modellevel.id %>" style="width: 70px;" value="<%=GetUserLevelPrice(modellevel.id) %>" onkeyup="value=value.replace(/[^.\d]/g,'')" />
                            </td>
                            <td></td>
                        </tr>
                        <%} %>
                    ...
                    { %><label title="<%=Tag(" 同步更新子商品")%>
                        "><input type="checkbox"
                                 name="UpdateUserLevelPrice" shop="true" id="UpdateUserLevelPrice" value="1" /><em><%=Tag("同步")%></em>
                    </label><%} %>
                </td>
            </tr>
            <%}%>
    ...
    <script type="text/javascript">
        ...
        function Edit(id1) {
            ChangePro_Type();getImages();ChangeProductType();ChangeProductStatus();GetProductType(<%=model.Pro_Type_id %>);getproducts();
