...
namespace Shop.Admin.Ajax
{
    public partial class Ajax_login : PageBase
    {
        ...
        public void Licence_Set()
        {
            ...
            try
            {
                string res = B_API.License_Set("SetUser", "username=" + LicenseUserName + "&pwd=" + LicensePWD + "&domain=" + LicenseDomain + "&Version=" + ShopCache.GetBaseConfig().Version + "&Version_Son=" + ShopCache.GetBaseConfig().Version_Son);
