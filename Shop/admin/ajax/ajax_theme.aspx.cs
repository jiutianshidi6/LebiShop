...
{
    public partial class Ajax_theme : AdminPageBase
    {
        ...
        public void Theme_publish()
        {
            ...
            string res = B_API.Theme_Upload(model);
        ...
        public void Theme_DownLoad()
        {
            ...
            int id = RequestTool.RequestInt("id", 0);
            string res = B_API.Theme_DownLoad(id, null);
            Response.Write("{\"msg\":\"" + res + "\"}");
        }
        /// <summary>
        /// 升级一个主题
        ...
        public void Theme_Update()
        {
            ...
            string res = B_API.Theme_DownLoad(0, theme);
            Response.Write("{\"msg\":\"" + res + "\"}");
        }
        /// <summary>
        /// 检测主题更新
        ...
        public void Theme_CheckVersion()
        {
            ...
            bool flag = B_API.Theme_CheckVersion();
            if (flag)
                Response.Write("{\"msg\":\"OK\"}");
            else
