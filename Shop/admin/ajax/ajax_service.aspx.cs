...
{
    public partial class Ajax_service : AdminPageBase
    {
        ...
        public void Licence_Set()
        {
            ...
            try
            {
                string res = B_API.License_Set("SetUser", "username=" + LicenseUserName + "&pwd=" + LicensePWD + "&domain=" + LicenseDomain + "&Version=" + ShopCache.GetBaseConfig().Version + "&Version_Son=" + ShopCache.GetBaseConfig().Version_Son + "&code=" + cf.InstallCode);
        ...
        public void Version_DownLoad()
        {
            ...
            string remoteUri = B_API.downurl;
        ...
        public void Version_Files()
        {
            ...
            string res = B_API.API("VersionFiles", "Version=" + Version + "&Version_Son=" + Version_Son + "");
            Response.Write(res);
        }
        ...
        public void Version_FileUpdate()
        {
            ...
            if (!Shop.Bussiness.B_API.ISRightVersion(SYS, model))
            {
                Response.Write("{\"msg\":\"" + Tag("参数错误") + "\"}");
                return;
            }
        ...
        public void LanguageTagVersion()
        {
            ...
            Lebi_Language_Tag_Version model = B_API.LanguageTagVersion(lang);
