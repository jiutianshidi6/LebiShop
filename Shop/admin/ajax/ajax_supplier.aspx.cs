...
{
    public partial class ajax_supplier : AdminPageBase
    {
        ...
        public void Verified_Log_Update()
        {
            ...
            List<Lebi_Supplier_Verified_Log> models = B_Lebi_Supplier_Verified_Log.GetList("Supplier_id = " + user_id + " and id in (lbsql{" + ids + "})", "id desc");
