...
<div id="sidecontent" class="clear">
    ...
    <table id="list" class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_Agent_Product amodel in models)
          {
              Shop.Model.Lebi_Product model = Shop.Bussiness.EX_Product.GetProduct(amodel.Product_id);
              Shop.Model.Lebi_Agent_Product_User auser = GetAgentUser(amodel.User_id);
          %>
        <script type="text/javascript">
            ...
            <tr class="list">
                ...
                <td><%=Lang(model.Name)%>&nbsp;<a target="_blank" href="<%=Shop.Bussiness.ThemeUrl.GetURL("P_Product",model.id.ToString(),"",CurrentLanguage.Code)%>"><img src="<%=PageImage("icon/newWindow.png")%>" /></a>
