<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.agent.areaagent_edit_window" validateRequest="false"%>
...
<script type="text/javascript">
    ...
    function SaveObj() {
        ...
        var url = "<%=site.AdminPath %>/ajax/ajax_agent.aspx?__Action=AreaAgent_Edit&id=<%=model.id %>&Area_id="+Area_id+"&PArea_id="+PArea_id;
