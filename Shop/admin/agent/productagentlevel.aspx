<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.agent.productagentlevel" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <table class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_Agent_Product_Level model in models)
          {%>
