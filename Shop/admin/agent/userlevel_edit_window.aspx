<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.agent.UserLevel_Edit_Window" validateRequest="false"%>
    ...
    <script type="text/javascript">
        function SaveObj() {
            ...
            if (!CheckForm("shop", "span"))
                return false;
            var url= "<%=site.AdminPath %>/ajax/ajax_agent.aspx?__Action=UserLevel_Edit&id=<%=id %>";
