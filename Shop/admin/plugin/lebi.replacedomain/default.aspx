<%@ Page Language="C#" AutoEventWireup="true" Inherits="Lebi.ReplaceDomain.Admin.plugin.Config" validateRequest="false"%>
...
<meta name="author" content="LebiShop" />
    ...
    <title><%=Tag("批量替换")%>-<%=site.title%></title>
...
<div id="sidecontent" class="clear">
    ...
    <li class="name"><span id="navIgation"><%=Tag("当前位置")%>：<a href="<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a> > <%=Tag("批量替换")%></span></li>
    </ul>
    </div>
    ...
    <table class="table">
        <tr>
            ...
            <td>
                <input type="text" id="olddomain" name="olddomain" value="" class="input" style="width: 200px;" shop="true" />
            </td>
        </tr>
        <tr>
            <th style="vertical-align:top">
            ...
            <td>
                <input type="text" id="newdomain" name="newdomain" value="" class="input" style="width: 200px;" shop="true" />
            </td>
        </tr>
    </table>
    <script type="text/javascript">
        function SaveObj() {
            ...
            var postData = { 'olddomain': olddomain, 'newdomain': newdomain};
            var url = "<%=site.AdminPath %>/plugin/Lebi.ReplaceDomain/ajax.aspx?__Action=Update";
