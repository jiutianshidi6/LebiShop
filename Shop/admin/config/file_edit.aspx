<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.config.file_edit" validateRequest="false"%>
...
<meta name="author" content="LebiShop" />
    ...
    <title><%=Tag("文件编辑")%>-<%=site.title%></title>
    <style>
    textarea
    {
       font-size:12px;
...
<div id="sidecontent" class="clear">
    ...
    <a href="filelist.aspx"><%=Tag("文件编辑")%></a></span></li>
    </ul>
    </div>
    ...
    <script type="text/javascript">
        function SaveObj() {
            ...
            var url = "<%=site.AdminPath %>/ajax/ajax_site.aspx?__Action=File_Edit&file=<%=FileName %>";
