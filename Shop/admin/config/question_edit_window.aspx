<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.Config.Question_Edit_window" validateRequest="false"%>
...
<script type="text/javascript">
    ...
    function SaveObj() {
        ...
        var url = "<%=site.AdminPath %>/ajax/ajax_site.aspx?__Action=Question_Edit&id=<%=model.id %>";
