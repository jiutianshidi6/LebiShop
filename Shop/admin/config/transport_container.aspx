<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.storeConfig.Transport_Container" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <%}%>
    <li class="name"><span id="navIgation"><%=Tag("当前位置")%>：<a href="<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a> > <a href="Transport.aspx"><%=Tag("配送方式")%></a> > <%=Tag("货柜管理")%></span></li>
    </ul>
    </div>
    ...
    <table class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_Transport_Container model in models)
          {%>
    ...
    <script type="text/javascript">
        ...
        function Edit(id) {
            ...
            var url_ = "transport_container_edit_window.aspx?id=" + id;
            var width_ = 500;
            var height_ = "auto";
            var modal_ = true;
