...
namespace Shop.Admin.Config
{
    public partial class Version : AdminPageBase
    {
        ...
        public void LicenseWord()
        {
            if (!power)
            {
                Response.Write("<div class=\"licensealt\"><p class=\"title\">手动升级步骤</p>");
                Response.Write("1,下载升级文件</br>2,使用ftp工具上传升级文件至相应路径</br>3,刷新页面,出现“升级”按钮</br>4,点击“升级”按钮,升级完毕</br>");
                Response.Write("<p class=\"title\">注册并在您的商城后台<a href=\"license.aspx\" target=\"_blank\">帐户设置</a>配置好帐户信息即可使用一键升级功能，<a href=\"" + B_API.weburl + "/user/register.html\" target=\"_bank\">点此注册</a>。</p>");
                Response.Write("</div>");
                return;
            }
        }
