...
{
    public partial class Transport_Price_Edit_window : AdminPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (Shop.Model.Lebi_Transport_Container cont in conts)
            {
                ...
                Containestr += "<td>";
                Containestr += " <input type=\"text\" class=\"input\" shop=\"true\" name=\"ContainerPrice" + cont.id + "\" id=\"ContainerPrice" + cont.id + "\" value=\"" + Convert.ToDecimal(kv.V) .ToString("0.00") + "\" style=\"width: 100px;\" onkeyup=\"value=value.replace(/[^\\d]/g,'')\" /> <span></span>";
                Containestr += "</td></tr>";
            }
        }
