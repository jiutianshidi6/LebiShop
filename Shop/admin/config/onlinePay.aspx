<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.storeConfig.OnLinePay" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <table id="list" class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_OnlinePay model in models)
          {
          Shop.Model.Lebi_Supplier supplier = Shop.Bussiness.B_Lebi_Supplier.GetModel(model.Supplier_id);
            if (supplier == null)
                supplier = new Shop.Model.Lebi_Supplier();
        ...
        <%foreach (Shop.Model.Lebi_OnlinePay son in GetPays(model.id))
        {
        supplier = Shop.Bussiness.B_Lebi_Supplier.GetModel(son.Supplier_id);
        if (supplier == null)
        supplier = new Shop.Model.Lebi_Supplier();
