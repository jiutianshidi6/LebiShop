<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.sorteConfig.Language" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <table class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_Site model in models)
          {%>
        <tr class="list" ondblclick="EditArea(<%=model.id %>);" >
            ...
            <td>
                <%=model.SubName %> <a href="<%if (model.Domain==""){ %><%=models.FirstOrDefault().Domain=="" ? site.WebPath + model.Path : "http://"+ models.FirstOrDefault().Domain + model.Path%><%}else{ %>http://<%=model.Domain%><%} %>" target="_blank"><img src="<%=PageImage("icon/newWindow.png")%>" /></a>
            </td>
            <td>
                <%=model.Path %>
            </td>
