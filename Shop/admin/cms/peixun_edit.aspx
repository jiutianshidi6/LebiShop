...
<div id="sidecontent" class="clear">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <textarea id="sourceurl" name="sourceurl" shop="true" cols="95" rows="4" class="textarea"
                    style="width: 500px; height: 60px;"><%=page.sourceurl%></textarea>
        ...
        <tr>
            ...
            <td>
                <textarea id="Content" name="Content" shop="true" class="textarea" style="height: 60px;
                    width: 450px;"><%=page.Content%></textarea>
                <div id="imagesdiv">
                </div>
        ...
        <tr>
            ...
            <td>
                 <label><input type="radio" name="target" value="image" <%=page.target=="image"?"checked":"" %> shop="true">图片</label>
                 <label><input type="radio" name="target" value="video" <%=page.target=="video"?"checked":"" %> shop="true">视频</label>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" id="Author" name="Author" shop="true" class="input" style="width: 70px"
                    maxlength="4" value="<%=page.Author %>" onkeyup="value=value.replace(/[^\d]/g,'')" />
            </td>
        </tr>
        <tr>
            <th>
    ...
    <script type="text/javascript">
        ...
        function getImages() {
            var images = $("#Content").val();
            $.ajax({
                type: "POST",
                url: "<%=site.AdminPath %>/product/imagesupload.aspx?input=Content&pid=<%=page.id %>",
                data: { "images": images },
