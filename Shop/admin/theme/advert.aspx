<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.theme.Advert" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <table class="datalist">
        ...
        <tr class="list" ondblclick="Editobj(<%=theme.id %>,<%=model.id %>);">
            ...
            <td>
                <a href="AdvertList.aspx?tid=<%=theme.id %>&id=<%=model.id %>"><%=Shop.Bussiness.B_Lebi_Advert.Counts("Theme_Advert_id=" + model.id) %></a>
            </td>
            <td>
                <%=model.Sort %>
            </td>
