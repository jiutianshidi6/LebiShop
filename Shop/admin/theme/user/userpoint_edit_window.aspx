<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.user.UserPoint_Edit_window" validateRequest="false"%>
...
<table cellspacing="0" border="0" style="width: 100%; border-collapse: collapse;" id="common" class="table">
    ...
    <tr>
        ...
        <td style="text-align: left;">
            <%=Shop.Bussiness.EX_Type.TypeRadio("PointStatus", "Type_id_PointStatus", model.Type_id_PointStatus, "shop=\"true\"")%>
        </td>
    </tr>
    <tr  >
        <th valign="top">
