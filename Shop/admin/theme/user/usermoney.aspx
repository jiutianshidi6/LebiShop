<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.user.UserMoney" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <div class="searchbox">
        <select name="type" id="type">
            ...
            <%=Shop.Bussiness.EX_Type.TypeOption("MoneyType", type)%>
        </select>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0" class="datalist">
        ...
        <%foreach (Shop.Model.Lebi_User_Money model in models)
          {
           %>
        <tr class="list" ondblclick="EditObj(<%=model.User_id+","+ model.id %>);">
            ...
            <td>
                <%=Shop.Bussiness.EX_Type.TypeName(model.Type_id_MoneyType)%>
            </td>
            <td>
                <%=model.Remark %>&nbsp;
            </td>
