...
<table class="table" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td>
            <input name="Birthday1" shop="true" type="text" class="input-calendar" onclick="WdatePicker()" style="width: 120px;" value="<%=model.Birthday1 %>"/>
            -
            <input name="Birthday2" shop="true" type="text" class="input-calendar" onclick="WdatePicker()" style="width: 120px;" value="<%=model.Birthday2 %>"/>
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            <input name="Time_reg1" shop="true" type="text" class="input-calendar" onclick="WdatePicker()" style="width: 120px;" value="<%=model.Time_reg1 %>"/>
            -
            <input name="Time_reg2" shop="true" type="text" class="input-calendar" onclick="WdatePicker()" style="width: 120px;" value="<%=model.Time_reg2 %>"/>
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            <input name="Time_login1" shop="true" type="text" class="input-calendar" onclick="WdatePicker()" style="width: 120px;" value="<%=model.Time_login1 %>"/>
            -
            <input name="Time_login2" shop="true" type="text" class="input-calendar" onclick="WdatePicker()" style="width: 120px;" value="<%=model.Time_login2 %>"/>
        </td>
    </tr>
    <tr>
        <th>
