<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.theme.advertment" validateRequest="false"%>
...
<div id="sidecontent" class="clear">
    ...
    <table class="datalist">
        ...
        <%
            foreach (Shop.Model.Lebi_Theme_Advert model in models)
                {%>
        <tr class="list" ondblclick="window.location='AdvertList.aspx?id=<%=model.id %>&tid=<%=model.Theme_id %>';">
            ...
            <td>
                <a href="AdvertList.aspx?id=<%=model.id %>&tid=<%=model.Theme_id %>"><%=Shop.Bussiness.B_Lebi_Advert.Counts("Theme_Advert_id=" + model.id)%></a>
            </td>
            <td>
                <%=model.Sort%>
            </td>
